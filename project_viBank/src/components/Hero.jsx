      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1  font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px]">
            ...
            <span className="text-gradient">پرداخت</span>{" "}
          </h1>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          تیم متخصصان ما از یک روش برای شناسایی کارت‌های اعتباری استفاده می‌کند
          که به احتمال زیاد با نیازهای شما سازگار است. ما نرخ‌های درصد سالانه،
          هزینه‌های سالانه را بررسی می‌کنیم.
        </p>
      </div>
